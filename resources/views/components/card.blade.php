...
<div class="block text-left bg-white rounded-md shadow-lg dark:bg-neutral-700">
    ...
    <div class="px-6 py-4 border-b-2 border-neutral-100 dark:border-neutral-500">
        ...
        <span class="mr-2">
            @if ($button)
                <a href="{{$href}}" wire:navigate class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    {{$buttonText}}
