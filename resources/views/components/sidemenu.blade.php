    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gradient-to-t from-green-300 to-green-100">
        ...
        @canany(['read roles and permission', 'create roles and permission', 'update roles and permission', 'delete roles and permission'])
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('roles-permission.index') }}" wire:navigate class="group flex items-center p-2 {{ request()->routeIs('roles-permission.index') ? 'text-green-50 bg-green-500' : ''}}  rounded-lg dark:text-white hover:bg-green-400 hover:text-green-50 dark:hover:bg-gray-700 group">
