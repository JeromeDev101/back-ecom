<div>
    <x-page-header back="true" link="{{ route('curriculum-performance.banner') }}">Edit Banner</x-page-header>
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="grid gap-4 mb-3 grid-col-1">
                <div>
                    ...
                    <x-input type="file" wire:model="newFile" accept="image/x-png,image/gif,image/jpeg" />
