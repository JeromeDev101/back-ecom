...
class CustomTheme extends Tailwind
{
    ...
    public function footer(): Footer
    {
        return Theme::footer()
            ...
            ->select('block appearance-none bg-green-500 border border-pg-primary-300 text-pg-primary-700 py-2 px-3 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-pg-primary-500 dark:bg-pg-primary-700 dark:text-pg-primary-200 dark:placeholder-pg-primary-200 dark:border-pg-primary-500');
    }
